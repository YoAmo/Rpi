...
# ~/bin/cine.sh
# CRE: 11/02/2021
# VERSION ANTERIOR: ~/bin/registra

## PROCESO ##
# Viene a mejorar el programa anterior 'registra'.
# Mantiene un directorio general donde se guardan las películas y otros archivos de soporte: '.DATA'
# Permite crear nuevas listas para facilitar la exportación y la clasificación en Kodi o Plex
...
declare -r ruta_LOCAL="/mnt/media/Cine"
